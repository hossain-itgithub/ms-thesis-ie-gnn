...
def main(resume_training=False, resume_config_path=None, resume_model_path=None):
    if resume_training:
        ...
        model_config = {
            ...
            "num_gat_heads": 6,  # Example number of GAT heads
    ...
    dataset = InvoiceDataset(ocr_dir, gt_dir, error_dir, bert_emb_dir, model_config["regenerate_bert_embeddings"])
    loader = DataLoader(dataset, batch_size=model_config["batch_size"], shuffle=True)

    # Create test dataset and dataloader
    test_dataset = TestInvoiceDataset(test_ocr_dir, test_gt_dir, error_dir, bert_emb_dir, model_config["regenerate_bert_embeddings"])
